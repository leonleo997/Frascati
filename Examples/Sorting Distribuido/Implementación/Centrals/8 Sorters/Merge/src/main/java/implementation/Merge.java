...
public class Merge implements IMerge{
	...
	public ArrayList<Character> merge(ArrayList<ArrayList<Character>> listas, int tamanioListafinal) {
		...
		for (int i = 0; i < tamanioListafinal; i++) {
			...
			&& lista1.get(w).compareTo(lista5.get(a))<=0
			&& lista1.get(w).compareTo(lista6.get(b))<=0
			&& lista1.get(w).compareTo(lista7.get(c))<=0
			&& lista1.get(w).compareTo(lista8.get(d))<=0) {
			...
			&& lista2.get(x).compareTo(lista5.get(a))<=0
			&& lista2.get(x).compareTo(lista6.get(b))<=0
			&& lista2.get(x).compareTo(lista7.get(c))<=0
			&& lista2.get(x).compareTo(lista8.get(d))<=0) {
			...
			&& lista3.get(y).compareTo(lista5.get(a))<=0
			&& lista3.get(y).compareTo(lista6.get(b))<=0
			&& lista3.get(y).compareTo(lista7.get(c))<=0
			&& lista3.get(y).compareTo(lista8.get(d))<=0) {
			...
			&& lista4.get(z).compareTo(lista5.get(a))<=0
			&& lista4.get(z).compareTo(lista6.get(b))<=0
			&& lista4.get(z).compareTo(lista7.get(c))<=0
			&& lista4.get(z).compareTo(lista8.get(d))<=0) {
